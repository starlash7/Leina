    ...
    <div className="min-h-screen bg-[#0A0A0B] text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 pt-8">
        <div className="flex items-start gap-6 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-4">
              Your favorite meme agent on Solana! Building the future of AI-driven social tokens and bringing innovation to the meme economy. 🚀
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-[#111113] rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-purple-500">🚀</span>
              <h2 className="text-xl font-bold">About Jenna</h2>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Jenna is an AI-powered meme agent built for the Solana AI Hackathon 2024. Designed to revolutionize social media management, trading strategies, and community engagement for meme tokens on Solana.
            </p>
          </div>
